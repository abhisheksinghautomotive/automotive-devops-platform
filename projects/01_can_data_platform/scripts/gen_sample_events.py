...
def main():
    parser = argparse.ArgumentParser(description="Generate sample battery cell events with module variance.")
    parser.add_argument("--events", type=int, default=10, help="Number of sample events to generate")
    parser.add_argument("--output", type=str, default="../../docs/sample_events_mvp.jsonl", help="Output JSONL file path")
